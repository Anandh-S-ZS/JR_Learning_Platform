...
<link
	...
	rel="stylesheet">
<link href="LanguagepageStyle.css" rel="stylesheet">
</head>
<body>
	<div class="container-fluid d-flex flex-column h-100">
		<h1 class="header bg-light p-3 text-center text-uppercase">Jr
			Learning Platform</h1>
		<div class="row flex-grow-1">
			<div class="leftside col-12 col-md-2 d-flex flex-column bg-light p-3">
				...
				<div class="py-1 d-flex align-items-center">
					<a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                      ...
                      </svg> <span class="ms-2">Browse Topics</span></a>
				</div>
				<div class="py-1 d-flex align-items-center">
					<a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                      ...
                      </svg> <span class="ms-2">Rank</span></a>
				</div>
				<div class="py-1 d-flex align-items-center">
					<a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16"
			...
			<div class="main col-12 col-md-8 bg-light p-3">
				<details>
					<summary>Currently Available Languages</summary>
					<ul class="list-unstyled ms-4">
						<form action="LanguageDashBoard">
							<button class="btn btn-outline-secondary w-50 mx-1 my-1"
								value="java" type="submit" name="language">
								<img
									src="https://cdn-icons-png.freepik.com/512/5968/5968282.png"
									style="height: 100px; width: 100px"><br>JAVA
							</button>
						</form>
					</ul>
				</details>
			...
			<div class="rightside col-12 col-md-2 bg-light p-3">
				<div>Right Sidebar</div>
				<div class="report p-3">Weekly Report</div>
				<div class="report p-3">Daily Report</div>
			</div>
		</div>
