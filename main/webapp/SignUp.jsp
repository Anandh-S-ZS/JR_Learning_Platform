    ...
    <div class="main">    
        ...
        <div class="container custom-container rounded-5 mt-5 shadow-lg p-5">
            <div class="progress mb-4">
                <div id="progress-bar" class="progress-bar progress-bar-animated  progress-bar-striped " role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
        
            <form id="regForm" action="signup">
                ...
                <div class="step">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <input type="button" class="btn btn-primary w-100" value="Generate OTP" id="otp" onclick="clickOtp()">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col" id="otpDiv">
                            <input type="text" class="form-control" placeholder="Enter OTP" id="OtpBox" name="otp" required>
                        </div>
                    </div>
                ...
                <div class="step">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="state" value="beginner">
                        <label class="form-check-label" for="beginner">
                          Beginner
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="state" value="intermediate" checked>
                        <label class="form-check-label" for="intermediate">
                            Intermediate
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="state" value="expert" checked>
